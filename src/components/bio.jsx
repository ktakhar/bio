            ...
            <div className="main-container">
                ...
                <div className="bio-container">
                    ...
                    <div className="bio-text">
                        ...
                        <p>She notably contributed her efforts and experience to the Harvard Humanitarian Initiative by analyzing complex data sets to identify root causes of refugee crisis and recommending corrective actions. These recommendations have been instrumental in guiding governments and industries towards a more effective response to critical issues and predicting future occurrence.</p>
                        <p className="text">Today, Kuljit applies technology to make impactful, ethical, meaningful change in the way that we live by partnering exclusively with mission driven organizations committed to making the world a better place. </p>
