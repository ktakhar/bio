            ...
            <div className="main-container">
                ...
                <div className="bio-container">
                    ...
                    <div className="bio-text">
                        ...
                        <p className="text">Today, Kuljit applies technology to make impactful, ethical, meaningful change in the way that we live by working exclusively with mission driven organizations committed to making the world a better place. </p>
